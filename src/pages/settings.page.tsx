...
export const SettingsPage = () => {
  ...
  function onSubmit(values: z.infer<typeof settingsSchema>) {
    // You can handle file upload and API call here
    console.log(values);
  }
          ...
          <Stack className="w-full bg-white border-1 border-gray-200 p-8 rounded-xl max-md:px-3 ">
            ...
            <Flex className="justify-between w-xs max-sm:w-full">
              <img
                ...
                alt="Profile"
                className="rounded-full border-2 border-dashed border-gray-600"
                style={{ width: 88, height: 88, objectFit: "cover" }}
              />

              <Flex className="flex-col gap-2">
                <Button className="bg-black text-white rounded-full flex items-center gap-2 cursor-pointer h-10 w-30 hover:bg-black/80">
                  Choose File
                </Button>
                <Button className="bg-[#DDDDDD] text-black rounded-full flex items-center gap-2 cursor-pointer h-10 w-30 hover:bg-[#DDDDDD]/80">
                  Remove
                </Button>
              </Flex>
            </Flex>
